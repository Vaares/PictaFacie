<?php
// Configurações do servidor, banco de dados, usuario e senha onde o PHP vai se conectar
$servidor='localhost';
$db = "pictafacie";
$user = 'root';
$pass = ''; 
...
try {
  // $conn - é a variável que irá receber os dados da conexão ao Banco de dados
  // No caso do exemplo um servidor MySQL
  $conexao = new PDO('mysql:host='.$servidor.';dbname='.$db ,  $user, $pass);
